...
class TelegramBot:
    ...
    def action(self):
        ...
        if self.incoming_message_text == '/hello':
            self.outgoing_message_text = "Hello {} {}!".format(self.first_name, self.last_name) + "  " + "I am an E-Commerce Bot and i can help you with an E-Commerce product suggestion of your need. Go ahead and type /MOUSE for a trial of how i work :)." 
            #self.outgoing_message_text = "I am an E-Commerce Bot and i can help you with an E-Commerce product suggestion of your need. Go ahead and type /MOUSE for a trial of how i work :)."     
            success = self.send_message()
  
        if self.incoming_message_text == '/mouse':
            self.outgoing_message_text = "Product Title: Logitech G502 Wired Gaming Mouse Black \nPros:\nLots of buttons \nComfortable to hold and use in any non gaming application. \nCons:\nIt's heavy. \nScroll wheel feels cheap and rattles when you move the mouse. \nLink: https://amzn.to/2RWDOZJ"
            success = self.send_message()
